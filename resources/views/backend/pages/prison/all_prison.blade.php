...
<div class="page-content">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="gradeModalLabel">Prison</h5>
                        ...
                        <div class="modal-body">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{route('store.prison')}}" class="forms-sample"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="Entrer le nom d'un prisonnier">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Liste des Prisonniers</h6>
                                    ...
                                    <td>
                                        ...
                                        <div class="modal fade" id="editModal{{$item->id}}" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="editModalLabel">Modifier Prison
                                                        </h5>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="card">
                                                            <div class="card-body">
                                                                ...
                                                                <form method="POST"
                                                                    action="{{route('update.prison', ['id' => $item->id]) }}"
